  ...
  return (
    <div className="relative w-full">
      <select
        ...
        className="w-full h-[38px] pl-4 pr-8 text-sm md:text-base rounded-[980px] bg-white text-[var(--color-text)] border border-[var(--color-border)] outline-none cursor-pointer appearance-none transition-colors duration-200 hover:border-[#A1A1AA]"
      >
...
export default function FilterBar({
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-50 bg-[var(--color-bg)] border-b border-[var(--color-border)] px-5 py-3 flex flex-col gap-3 md:hidden">
        <div className="relative w-full">
      ...
      {/* Desktop layout */}
      <div className="hidden md:block px-5 lg:px-10 pb-8">
        <div className="grid grid-cols-5 items-center gap-2 min-w-0">
